...
def _get_cityscapes_files(image_dir, gt_dir):
    ...
    for city in cities:
        ...
        for basename in PathManager.ls(city_img_dir):
            ...
            # Hacky way to load depth file
            img_ext = os.path.splitext(os.path.basename(image_file))[-1]
            depth_file = None
            if "cityscapes_foggy" in image_file:
                depth_file = image_file.replace("datasets/cityscapes_foggy/leftImg8bit", "/home/bui/DAOD/auxiliary_information/cityscapes_foggy/").replace(img_ext, ".pth")
            elif "cityscapes" in image_file:
                depth_file = image_file.replace("datasets/cityscapes/leftImg8bit", "/home/bui/DAOD/auxiliary_information/cityscapes/").replace(img_ext, ".pth")
...
def load_cityscapes_instances(image_dir, gt_dir, from_json=True, to_polygons=True):
    ...
    ret = pool.map(functools.partial(_cityscapes_files_to_dict, from_json=from_json, to_polygons=to_polygons), files)
...
def load_cityscapes_semantic(image_dir, gt_dir):
    ...
    for image_file, _, label_file, json_file, depth_file in _get_cityscapes_files(image_dir, gt_dir):
...
def _cityscapes_files_to_dict(files, from_json, to_polygons):
    ...
    image_file, instance_id_file, label_file, json_file, depth_file = files
